...
const index = (props) => {
    ...
    const _signUp=async(name, email,password,confirmPassword,phone,apartment,zip,city,country)=>{
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Button label="Đăng ký" width={150} style={styles.button} onPress={()=>_signUp(name, email,password,confirmPassword,phone,apartment,zip,city,country)}/>
        </SafeAreaView>
    );
}
